...
#define f_new_inst(ctx, ...) MACRO_CONCAT_AFTER(f_new_inst_, MACRO_FIRST(__VA_ARGS__))(ctx, __VA_ARGS__)
...
struct f_line *f_linearize(struct cf_context *ctx, const struct f_inst *root);
...
struct filter *f_new_where(struct cf_context *ctx, struct f_inst *);
